                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          ...
                          if(eventList[index].text.toLowerCase() == "arrive") {
                            Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) {
                              return ArrivePage(childList: childList, time: time, minutes : minutes);
                            }));
                          } else if(eventList[index].text.toLowerCase() == "food") {
                            Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) {
                              return EatPage(childList: childList, time: time,minutes : minutes  );
                            }));  
                          } else if(eventList[index].text.toLowerCase() == "diaper") {
                            Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) {
                              return ChangeDiapersPage(childList: childList, time: time, minutes : minutes);
                            }));
                          } else if(eventList[index].text.toLowerCase() == "play") {
                            Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) {
                              return PlayPage(childList: childList, time: time, minutes : minutes);
                            }));
                          } else if(eventList[index].text.toLowerCase() == "sleep") {
                            Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) {
                              return SleepPage(childList: childList, time: time, minutes : minutes);
                            }));
                          } else if(eventList[index].text.toLowerCase() == "care") {
                            Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) {
                              return CarePage(childList: childList, time: time, minutes : minutes);
                            }));
                          } else if(eventList[index].text.toLowerCase() == "leave") {
                            print('leave');
                            Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) {
                              return LeavePage(childList: childList, time: time, minutes : minutes);
                            }));
                          } else {
                            print('hello');
                          }
