  ...
  Future<bool> _onBackPressed() async {
    ...
    await showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text("${fields.doYouReallyWantToExit}"),
        content: Row(
          children: <Widget>[
            Expanded(
              child: Container(
                child: FlatButton(
                  child: Text('${fields.no}'),
                  onPressed: () {
                      ...
                      child: Stack(
                        ...
                        children: <Widget>[
                          ...
                          new Container(
                            ...
                            child: Text(
                              "${fields.or} ${fields.login} ${fields.charWith} ",
                              style: TextStyle(
                                color: black,
                                fontSize: 14.0
                              ),
                    ...
                    child: RaisedButton(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Container(),
                          Text(
                            "${fields.login.toUpperCase()} ${fields.charWith.toUpperCase()} FACEBOOK",
                            style: TextStyle(
                              fontSize: 18.0,
                              color: Colors.white,
                        ...
                        fbLogin.logInWithReadPermissions(['email', 'public_profile'])
                            .then((result) {
                              ...
                              switch (result.status) {
                                ...
                                //     content:
                                //         Text("${fields.someErrorOccuredNow} ${fields.loginWithEmailAndPassword}"),
                              ...
                              var snackbar = SnackBar(
                                    content:
                                        Text("${fields.someErrorOccuredNow} ${fields.create} ${fields.a} ${fields.account}"),
                                    duration: Duration(milliseconds: 5000),
                                  );
                    ...
                    child: GestureDetector(
                      ...
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: <TextSpan>[
                            TextSpan(
                              text: " ${fields.dontHaveAnAccount} ", 
                              style: TextStyle(
                                color: black,
                                fontSize: 14.0
                              )),
                            TextSpan(
                              text: ' ${fields.create} ${fields.account}!',
                              style: TextStyle(
                                color: blue,
                                fontSize: 14.0
                              )
