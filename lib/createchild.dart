...
class _ShowingAlertDialogState extends State<ShowingAlertDialog> {
  ...
  String _firstName, _lastName, _dateOfBirth, _childImage, _compInformation, _parentPin;
  ...
  Future getImage() async {
    ...
    var tempImage = await ImagePicker.pickImage(source: ImageSource.gallery, maxHeight: 250.0, maxWidth: 250.0);
